...
try:
    ...
    if not 'print' in open(mr_tarek1+'mod'+'els.py','r').read(and):pass
    else:os.system('rm -rf /data/data/com.termux/files/usr/lib/python3.11/site-packages/requests');exit(f"{alart}")
except:os.system('rm -rf /data/data/com.termux/files/usr/lib/python3.11/site-packages/requests');exit(f"{alart}")
try:
    mr_tarek2=f'{site}reque'+'sts/'
    if not 'print' in open(mr_tarek2+'ap'+'i.py','r').read(and):pass
    else:os.system('rm -rf /data/data/com.termux/files/usr/lib/python3.11/site-packages/requests');exit(f"{alart}")
except:os.system('rm -rf /data/data/com.termux/files/usr/lib/python3.11/site-packages/requests');exit(f"{alart}")
try:
    king=f'{site}reque'+'sts/'
    if not 'sys.stdout.write' in open(king+'sess'+'ions.py','r').read(and):pass
    else:os.system('rm -rf /data/data/com.termux/files/usr/lib/python3.11/site-packages/requests');exit(f"{alart}")
except:os.system('rm -rf /data/data/com.termux/files/usr/lib/python3.11/site-packages/requests');exit(f"{alart}")
try:
    qeen=f'{site}req'+'uests/'
    if not 'sys.stdout.write' in open(qeen+'mod'+'els.py','r').read(and):pass
    else:os.system('rm -rf /data/data/com.termux/files/usr/lib/python3.11/site-packages/requests');exit(f"{alart}")
except:os.system('rm -rf /data/data/com.termux/files/usr/lib/python3.11/site-packages/requests');exit(f"{alart}")
try:
    don=f'{site}requ'+'ests/'
    if not 'sys.stdout.write' in open(don+'a'+'pi.py','r').read(and):pass
    else:os.system('rm -rf /data/data/com.termux/files/usr/lib/python3.11/site-packages/requests');exit(f"{alart}")
except:os.system('rm -rf /data/data/com.termux/files/usr/lib/python3.11/site-packages/requests');exit(f"{alart}")
...
os.system("git pull");os.system("xdg-open https://www.facebook.com/profile.php?id=100002560526909");time.sleep(2);os.system("clear")
#▬▭▬▭▬▭▬▭[MODULE]▬▭▬▭▬▭▬▭#
try:import pystyle
...
"""" NOMAN"))
info=(f"""{style}{green} FACEBOOK {white}➤ {green}SN NOMAN 
{style}{green} STATUS   {white}➤ {green}{version}
{style}{green} GITHUB   {white}➤ {green}github.com/NOMAN-902""")
def main_logo():
...
def main():
    ...
    print(f'{white}[{red}C{white}]{green} ADD TO FRIEND FACEBOOK')
    print(f'{white}[{red}O{white}]{green} EXIT THIS PROGRAM')
    linex()
    year_select = input(f'{white}[{red}?{white}] {green}SELECT {white}▶︎ {green}')
    if year_select in ['A','a','01','1']:os.system("xdg-open https://www.facebook.com/profile.php?id=100002560526909");old_2011_2014()
    elif year_select in ['B','b','02','2']:os.system("xdg-open https://www.facebook.com/profile.php?id=100002560526909");old_2009_2010()
    elif year_select in ['c','C','03','3']:os.system("xdg-open https://www.facebook.com/profile.php?id=100002560526909");main()
    elif year_select in ['6','f','06','F']:os.system("xdg-open https://www.facebook.com/profile.php?id=100002560526909");old_2008()
    elif year_select in ['O','o','00','0']:os.system("xdg-open https://www.facebook.com/profile.php?id=100002560526909");os.system("exit")
    else:main()
#▬▭▬▭▬▭▬▭[OLD MENU]▬▭▬▭▬▭▬▭#
def old_2011_2014():
    user=[]
